...
class TaskInterface(TaskStructure):
	...
	def init_parameters(self):
		...
		bluearrowsyellowshapes = [blue_arrow_e, blue_arrow_n, blue_arrow_nw, blue_arrow_se, blue_arrow_sw, blue_arrow_s, blue_arrow_sw, blue_arrow_ne, blue_arrow_w, yellow_circle, yellow_star, yellow_triangle, yellow_star, yellow_circle, yellow_star, yellow_triangle, yellow_star]
		bluearrowsyellowarrows = [blue_arrow_e, blue_arrow_n, blue_arrow_nw, blue_arrow_se, blue_arrow_sw, blue_arrow_sw, blue_arrow_ne, blue_arrow_w, yellow_arrow_ne, yellow_arrow_nw, yellow_arrow_s, yellow_arrow_se, yellow_arrow_sw, yellow_arrow_e, yellow_arrow_w]
		yellowarrows=[yellow_arrow_ne, yellow_arrow_nw, yellow_arrow_s, yellow_arrow_se, yellow_arrow_sw, yellow_arrow_e, yellow_arrow_w, yellow_arrow_ne, yellow_arrow_nw, yellow_arrow_s, yellow_arrow_se, yellow_arrow_sw, yellow_arrow_e, yellow_arrow_w, yellow_arrow_s]
	...
	def build_trial(self, trial_parameters={}):
		...
		if len(distractor_positions) == 6:
				for position in distractor_positions:
					distractor = self.randomize_from(self.pseudorandom_parameters[Parameter.BLUEARROWSYELLOWARROWS]['values'], size=6)
				...
				for position in distractor_positions:
					...
					distractor_stim.outcome = Outcome.FAIL
					w3.add_stimulus(distractor_stim)
		elif len(distractor_positions) == 8:
				for position in distractor_positions:
					distractor = self.randomize_from(self.pseudorandom_parameters[Parameter.BLUESHAPES]['values'], size=8)
					distractor_stim = copy.copy(distractor[0])
					distractor_stim.position = position
					distractor_stim.outcome = Outcome.FAIL
					w3.add_stimulus(distractor_stim)
