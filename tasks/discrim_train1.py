...
class TaskInterface(TaskStructure):
	...
	def build_trial(self, trial_parameters={}):
		...
		# Window 1
		# set targets
		w1 = Window(transition=WindowTransition.TOUCH, is_outcome=True)
		reward_stim = Stimulus(shape=StimulusShape.IMAGE, size=(250,250), image = 'tasks/images/composite1-1.jpg', color = (0,0,0), size_touch=(250,250))
		penalty_stim = Stimulus(shape=StimulusShape.IMAGE, size=(250,250), image = 'tasks/images/composite1-2.jpg', color = (0,0,0), size_touch=(250,250))
