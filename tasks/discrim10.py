...
class TaskInterface:
    ...
    def load(self, trial_index):
        ...
        reward_stim = Stimulus(shape=StimulusShape.IMAGE, size=(250,250), image = '/media/sf_callicog/tasks/images/composite13-1.jpg', color = (1,1,1), size_touch=(250,250)) #will need to change path
        penalty_stim = Stimulus(shape=StimulusShape.IMAGE, size=(250,250), image = '/media/sf_callicog/tasks/images/composite13-2.jpg', color = (1,1,1), size_touch=(250,250)) #will need to change path
