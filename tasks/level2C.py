...
#IF I DONT WANT AN ELEMENT TO BE PSEUDORANDOMISED, ADD IT AFTER TRIALS = SELF.__PSEUDORANDOMISE PARAMETERS
	def get_trial(self, trial_index):
		...
		blue_arrowe = Stimulus(shape=StimulusShape.ARROWE,
					size=(20,20),
					color=(0, 0.7, 1),
					size_touch= (120,120))
		...
		yellow_circle = Stimulus(shape=StimulusShape.CIRCLE,
					...
					color=(1, 1, 0),
					size_touch= (120,120))
		blue_arroww = Stimulus(shape=StimulusShape.ARROWW,
					size=(20,20),
					color=(0, 0.7, 1),
					size_touch= (120,120))

		distractor_list = [blue_arrowe, yellow_star, yellow_circle, blue_arroww]
