...
#IF I DONT WANT AN ELEMENT TO BE PSEUDORANDOMISED, ADD IT AFTER TRIALS = SELF.__PSEUDORANDOMISE PARAMETERS
	def get_trial(self, trial_index):
		...
		blue_arrowup = Stimulus(shape=StimulusShape.ARROW,
					size=(20,20),
					color=(0, 0.7, 1),
					size_touch= (120,120))
		yellow_arrowdown= Stimulus(shape=StimulusShape.ARROW6,
					size=(20,20),
					color=(1, 1, 0),
					size_touch= (120,120))

		distractor_list = [blue_arrowup, yellow_arrowdown]
	...
	def load(self, trial_index):
		...
		for i in range(trial_parameters['ndistractor']):
			...
			distractor_stim.position = position[0]
