...
class TaskInterface(TaskStructure):
    ...
    def build_trial(self, trial_parameters={}):
        ...
        reward_stim = Stimulus(shape=StimulusShape.IMAGE, size=(250,250), image = 'tasks/images/composite8-2.jpg', color = (1,1,1), size_touch=(250,250))
        reward_stim.after_touch = [{'name': 'hide_other'}]
        penalty_stim = Stimulus(shape=StimulusShape.IMAGE, size=(250,250), image = 'tasks/images/composite8-1.jpg', color = (1,1,1), size_touch=(250,250))
